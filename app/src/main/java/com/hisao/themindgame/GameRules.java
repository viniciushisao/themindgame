 ...
 * {@link GameRules.OnFragmentInteractionListener} interface
...
public class GameRules extends Fragment {
    ...
    public static String TAG = "GAME_RULES";
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.gameRules_onFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void gameRules_onFragmentInteraction(Uri uri);
    }
}
